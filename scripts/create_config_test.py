...
def main(seed=489, out_dir='../config_files'):
    try:
        out_name = sys.argv[1]
    except:
        out_name = 'test.txt'
    ...
    run_parameters = {
        "file_list_path": '/hpf/largeprojects/smiller/users/Katharine/brain_segmentation/file_lists/ubc/masks/V02/FileList_ubc_Size=30_Split=0.9-0.1-0.0.csv',
         "epochs": 1,
         "out_dir": '/hpf/largeprojects/smiller/users/Katharine/brain_segmentation/runs/tests/testing_end'
    }
    ''''
    ...
    ubc/V02/FileList_ubc_Size=184_Split=0.9-0.075-0.025.csv
    ubc/V02/FileList_ubc_Size=184_Split=0.8-0.15-0.05.csv

    ubc/FileList_ubc_Size=204_Split=0.9-0.075-0.025.csv
    ubc/FileList_ubc_Size=204_Split=0.8-0.15-0.05.csv
    ubc/FileList_ubc_Size=30_Split=0.9-0.1-0.0.csv

    #DHCP FILELISTS
    dhcp/FileList_dhcp_Size=30_Split=0.9-0.1-0.0.csv
    dhcp/FileList_dhcp_Size=492_Split=0.8-0.15-0.05.csv
    dhcp/FileList_dhcp_Size=492_Split=0.9-0.1-0.0.csv
    dhcp/FileList_dhcp_Size=492_Split=0.9-0.075-0.025.csv
    ...
    resume_transfer_parameters = {
        "resume_flag": False,   
        "transfer_resume_flag": False,
        "transfer_train_flag": False,  
        # "new_num_labels": 10,
        # "old_num_labels": 10,
        "load_checkpoint_path": '/hpf/largeprojects/smiller/users/Katharine/brain_segmentation/trained_models/dhcp_models/vl=1367_nl=87_ss=[98,125,101].pt',
        #"load_checkpoint_path": '../trained_models/dhcp_models/vl=1926_nl=87_ss=[72,100,120].pt'
    }
