...
out_dir = os.path.join('/hpf/largeprojects/smiller/users/Katharine/brain_segmentation/file_lists/ubc/V01') # no masks
#out_dir = os.path.join('/hpf/largeprojects/smiller/users/Katharine/brain_segmentation/file_lists/ubc/masks/V01') # masks
...
'''POPULATE LISTS'''
data_file_path_1 = '/hpf/largeprojects/smiller/users/Katharine/data/connorSegmentation/images' # no masks
#data_file_path_1 = '/hpf/largeprojects/smiller/users/Katharine/data/connorSegmentation/images_brain_extracted_created_by_steve' # masks
