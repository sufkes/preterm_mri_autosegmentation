...
and tissue labels for the downsampled dhcp dataset. It marks a given percentage as train, val, and test files. 
...
out_dir = os.path.join('/hpf/largeprojects/smiller/users/Katharine/brain_segmentation/file_lists/dhcp/masks')
...
'''CONVERT AND SAVE'''
out_name = 'FileList_dhcp_Size='+str(num_files)+'_Split='+str(train_split)+'-'+str(val_split)+'-'+str(test_split)+'.csv'
